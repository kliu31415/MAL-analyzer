This is a program that analyzes data from MyAnimeList. The data was pulled with a separate program using libcurl and multithreading. This program functions as a shell and takes in the following arguments:
